# Core.Maui portfolio roadmap

## 90-day evidence snapshot
- Commits (90 days): 6
- Files changed (90 days): 33
- Last signal: 5340a73 (4 days ago)
- Top modified areas: docs(14);src(9);00_agile(6);wiki(2);README.md(1);.gitattributes(1)
- Notes: clean_at_scan
...
- [ ] Document owner and intent for area: docs(14)
